  ...
  {
    poly1 = newPolyLine(newPolyOptions(path1));
    poly2 = newPolyLine(newPolyOptions(path2));
    poly3 = newPolyLine(newPolyOptions(path3));
    poly4 = newPolyLine(newPolyOptions(path4));
    poly5 = newPolyLine(newPolyOptions(path5));
    poly6 = newPolyLine(newPolyOptions(path6));
    poly7 = newPolyLine(newPolyOptions(path7));
  }
